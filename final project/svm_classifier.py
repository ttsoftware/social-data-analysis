...
traffic_data = pandas.read_csv('traffic_data_has_injured_clean_zip_dummie_columns_day_of_week_weather.csv')
...
with open('svm_classifier_100000_daytime_weather.pkl', 'wb') as fid:
