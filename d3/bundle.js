...
$(function () {
    ...
    var svg = d3.select("#clusterErrors").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
},{"core-js":1,"d3":308,"jquery":309}],311:[function(require,module,exports){
'use strict';
...
},{"core-js":1,"d3":308}],313:[function(require,module,exports){
'use strict';
...
},{"./clusterErrors.js":310,"./loadCSV.js":311,"./loadJSON.js":312,"./plot/Geoplot.js":314,"./plot/ScatterPlot.js":316,"./plot/ScatterPlotDataPoint.js":317,"core-js":1,"d3":308,"jquery":309}],314:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Geoplot = undefined;
...
var Geoplot = exports.Geoplot = function (_Plot) {
    _inherits(Geoplot, _Plot);
    ...
    function Geoplot(height, width, mapData) {
        ...
        var _this = _possibleConstructorReturn(this, (Geoplot.__proto__ || Object.getPrototypeOf(Geoplot)).call(this, height, width, null, null));
...
var Plot = exports.Plot = function () {
     ...
     */
    function Plot(height, width, xAxis, yAxis) {
    ...
    _createClass(Plot, [{
        ...
        key: 'axisLabels',
        value: function axisLabels(svg, xAxisLabel, yAxisLabel) {
            svg.append("text").attr("class", "x-label").attr("text-anchor", "end").attr("x", this.width / 2).attr("y", this.height + 40).text(xAxisLabel);

            svg.append("text").attr("class", "y-label").attr("text-anchor", "end").attr("transform", "rotate(-90)").attr("x", -(this.height / 2.5)).attr("y", -50).text(yAxisLabel);
        }
    }, {
        key: 'height',
        get: function get() {
